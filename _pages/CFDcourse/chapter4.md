...
choosing a characteristic cell size; the asymptotic and 
pre-asymptotic regimes; estimating the observed order-of-accuracy; 
classifying convergence behavior
